...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setMaximumSize(new java.awt.Dimension(694, 436));
        jPanel1.setMinimumSize(new java.awt.Dimension(694, 436));
        jPanel1.setPreferredSize(new java.awt.Dimension(694, 436));
        ...
        jPanel1.add(emailField, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 50, -1, -1));
        ...
        jPanel1.add(email, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 50, -1, -1));
        ...
        jPanel1.add(passwordField, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 130, -1, -1));
        ...
        forgetPassword.setMaximumSize(new java.awt.Dimension(78, 36));
        forgetPassword.setMinimumSize(new java.awt.Dimension(78, 36));
        forgetPassword.setPreferredSize(new java.awt.Dimension(78, 36));
        jPanel1.add(forgetPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 210, 150, -1));
        ...
        showPasswordTickBox.setMaximumSize(new java.awt.Dimension(180, 43));
        showPasswordTickBox.setMinimumSize(new java.awt.Dimension(180, 43));
        showPasswordTickBox.setPreferredSize(new java.awt.Dimension(180, 43));
        showPasswordTickBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                showPasswordTickBoxActionPerformed(evt);
            }
        });
        jPanel1.add(showPasswordTickBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 210, -1, -1));
        ...
        jPanel1.add(password, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 130, 120, -1));

        login_button.setBackground(new java.awt.Color(27, 61, 96));
        login_button.setFont(new java.awt.Font("Bell MT", 1, 28)); // NOI18N
        login_button.setForeground(new java.awt.Color(255, 255, 255));
        login_button.setText("Login");
        login_button.setMaximumSize(new java.awt.Dimension(120, 45));
        login_button.setMinimumSize(new java.awt.Dimension(120, 45));
        login_button.setPreferredSize(new java.awt.Dimension(120, 45));
        jPanel1.add(login_button, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 340, -1, -1));

        back_button.setBackground(new java.awt.Color(27, 61, 96));
        back_button.setFont(new java.awt.Font("Bell MT", 1, 28)); // NOI18N
        back_button.setForeground(new java.awt.Color(255, 255, 255));
        back_button.setText("Back");
        back_button.setMaximumSize(new java.awt.Dimension(120, 45));
        back_button.setMinimumSize(new java.awt.Dimension(120, 45));
        back_button.setPreferredSize(new java.awt.Dimension(120, 45));
        jPanel1.add(back_button, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 340, -1, -1));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 210, 680, -1));
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 160, 260, -1));
