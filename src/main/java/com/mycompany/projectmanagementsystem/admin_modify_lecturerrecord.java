...
public class admin_modify_lecturerrecord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lec_name_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 130, 90, -1));
        ...
        getContentPane().add(lec_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 120, 190, 50));
        ...
        getContentPane().add(lecturer_gender_selection, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 120, 190, 50));
        ...
        getContentPane().add(lec_empno, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 60, 190, 50));
        ...
        getContentPane().add(lec_empno_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 60, 70, -1));
        ...
        getContentPane().add(lec_address_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 310, -1, -1));
        ...
        getContentPane().add(lec_address, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 300, 190, 50));
        ...
        getContentPane().add(lec_contact_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 180, 90, -1));
        ...
        getContentPane().add(lec_nation, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 240, 190, 50));
        ...
        getContentPane().add(lec_nation_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 250, -1, -1));
        ...
        getContentPane().add(lec_password_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 380, -1, -1));

        lec_password.setText("jPasswordField1");
        getContentPane().add(lec_password, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 360, 190, 50));
        ...
        getContentPane().add(lec_nric, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 240, 190, 50));
        ...
        getContentPane().add(lec_email, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 300, 190, 50));
        ...
        getContentPane().add(lec_email_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 300, -1, -1));
        ...
        getContentPane().add(lec_nric_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 240, 120, -1));
        ...
        getContentPane().add(lec_gender, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 130, -1, -1));
        ...
        getContentPane().add(lec_schoolwise_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 60, -1, -1));

        schoolwise_dropbox.setFont(new java.awt.Font("SansSerif", 0, 18)); // NOI18N
        getContentPane().add(schoolwise_dropbox, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 60, 190, 50));
        ...
        getContentPane().add(lec_details_background, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 30, 630, 420));
