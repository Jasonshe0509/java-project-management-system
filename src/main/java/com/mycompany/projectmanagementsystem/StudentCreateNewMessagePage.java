 ...
 * @author ASUS
 */
public class StudentCreateNewMessagePage extends javax.swing.JFrame {

    /**
     * Creates new form StudentCreateNewMessagePage
     */
    public StudentCreateNewMessagePage() {
        initComponents();
        setIconImage();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Student Create Message");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentCreateNewMessagePage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentCreateNewMessagePage().setVisible(true);
            }
        });
    }
