 ...
 * @author ASUS
 */
public class StudentECActionPanel extends javax.swing.JPanel {

    /**
     * Creates new form StudentECActionPanel
     */
    private int row = 0;
    public StudentECActionPanel() {
        initComponents();
    }
    ...
    public class rPanelActionRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            ...
            StudentECActionPanel action = new StudentECActionPanel();
    ...
    public class TableActionCellEditor extends DefaultCellEditor {
        private ECTableActionEvent event;
        public TableActionCellEditor(ECTableActionEvent event) {
            super(new JCheckBox());
            this.event = event;
        }
    ...
    public void initEvent(ECTableActionEvent event, int row , Object value) {
        deleteBtn.addActionListener(new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent ae) {
                event.ecDelete(row, value);
            }
        });
    }
