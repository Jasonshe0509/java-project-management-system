...
public class admin_modify_studentrecord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(student_name_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 170, 90, -1));
        ...
        getContentPane().add(student_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 160, 190, 50));

        student_gender_selection.setFont(new java.awt.Font("SansSerif", 0, 18)); // NOI18N
        getContentPane().add(student_gender_selection, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 160, 190, 50));
        ...
        getContentPane().add(intake_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 110, -1, 30));

        student_intake_selection.setFont(new java.awt.Font("SansSerif", 0, 18)); // NOI18N
        getContentPane().add(student_intake_selection, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 100, 190, 50));

        student_tpno.setEditable(false);
        student_tpno.setFont(new java.awt.Font("SansSerif", 0, 18)); // NOI18N
        getContentPane().add(student_tpno, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 100, 190, 50));
        ...
        getContentPane().add(student_tpno_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 110, -1, -1));
        ...
        getContentPane().add(student_dob_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 230, 110, 40));
        ...
        getContentPane().add(student_contact_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 220, 90, -1));

        student_contact.setFont(new java.awt.Font("SansSerif", 0, 18)); // NOI18N
        getContentPane().add(student_contact, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 220, 190, 50));

        student_nation.setFont(new java.awt.Font("SansSerif", 0, 18)); // NOI18N
        getContentPane().add(student_nation, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 280, 190, 50));
        ...
        getContentPane().add(student_nation_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 290, -1, -1));
        ...
        getContentPane().add(student_password_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 410, -1, -1));
        ...
        getContentPane().add(student_nric, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 280, 190, 50));
        ...
        getContentPane().add(student_nric_title, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 280, 120, -1));
        getContentPane().add(student_dob, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 220, 190, 50));
        ...
        getContentPane().add(student_gender, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 170, -1, -1));

        student_image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/student_image.png"))); // NOI18N
        getContentPane().add(student_image, new org.netbeans.lib.awtextra.AbsoluteConstraints(-50, 370, -1, -1));
        ...
        getContentPane().add(student_details_background, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, 630, 410));
        ...
        getContentPane().add(student_details_border, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, 650, 430));

        admin_modify_student_save.setBackground(new java.awt.Color(2, 50, 99));
        admin_modify_student_save.setFont(new java.awt.Font("Bell MT", 1, 18)); // NOI18N
        admin_modify_student_save.setForeground(new java.awt.Color(255, 255, 255));
        ...
        getContentPane().add(admin_modify_student_save, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 510, -1, -1));
