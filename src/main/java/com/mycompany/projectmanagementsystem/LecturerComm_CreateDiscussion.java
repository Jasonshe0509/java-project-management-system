 ...
 * @author user
 */
public class LecturerComm_CreateDiscussion extends javax.swing.JFrame {

    /**
     * Creates new form LecturerComm_CreateDiscussion
     */
    public LecturerComm_CreateDiscussion() {
        initComponents();
        setIconImage();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Lecturer Create Discussion");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LecturerComm_CreateDiscussion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LecturerComm_CreateDiscussion().setVisible(true);
            }
        });
    }
